...
namespace Compactador.Compactor
{
    class Descompactar
    {
        public void Descompacta(string text)
        {
         try
            {
            ...
            File.WriteAllText(@"E:\Users\Jason\Área de Trabalho/Descompactado.txt", textFinal.Replace("--", ""));//Cria arquivo com o texto descompactado
